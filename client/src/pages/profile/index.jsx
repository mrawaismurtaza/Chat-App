...
// import Image from "../../../../server/uploads/profiles/1721845138856Profile-User-Icon.png";
...
function Profile() {
  ...
  const handleNavigate = () => {
    if (userInfo.profileSetup) {
      ...
      toast.error("Setup Profile First");
    }
  };
          ...
          <div className="flex min-w-32 md:min-w-64 flex-col gap-5 text-white items-center justify-center">
            <div className="w-full">
              <Input
                ...
                className="rounded-lg p-6 bg-[#393942] border-none"
              />
            </div>
            <div className="w-full">
              <Input
